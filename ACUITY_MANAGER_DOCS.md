...
#### 🔧 Заобиколен вариант: Блокиране на календари БЕЗ достъп до Acuity профил (НОВ)

**За потребители без достъп до Acuity профил по никакъв начин:**

Ако нямате възможност да влезете в Acuity и API-то не позволява директна редакция на услуги, можете да блокирате всички календари за определен период. Това ефективно спира приемането на нови резервации.

**⚠️ ВАЖНО: Този метод блокира ЦЕЛИЯ календар (всички услуги), не само една конкретна услуга.**

**Как работи:**
1. Отидете в таб "Услуги"
2. Натиснете "Презареди услуги"
3. В секцията "🔧 Заобиколен вариант" изберете услуга (за проследяване)
4. Изберете период на блокиране (1 месец до 5 години)
5. Добавете бележка (опционално)
6. Натиснете "Блокирай всички календари"

**Какво се случва:**
- Създават се блокове (unavailable periods) за всички календари
- Блоковете предотвратяват ВСИЧКИ резервации, не само за избраната услуга
- Клиентите няма да виждат свободни часове за записване
- Избраната услуга се използва само за проследяване на блоковете
- Можете да изтриете блоковете по всяко време, за да възстановите календарите

**Забележки:**
- Блоковете засягат ВСИЧКИ услуги в календара
- Този метод е подходящ когато искате да спрете приемането на резервации изцяло
- За селективно спиране само на една услуга, трябва достъп до Acuity профила
- За да възстановите резервациите, трябва да изтриете създадените блокове от секция "Календари" → "Блокирани часове"
- Проследяването на блокираните календари се съхранява локално в браузъра
