...
4. По желание включете **"Автодебат"** и наблюдавайте как Платон брани автоматизацията, а Ницше се застъпва за хората. Опцията се спира от същата отметка или като напишете "стоп" в чата.
5. В този режим ботовете си четат репликите и се изчакват, за да спорят помежду си.
6. Отговорите се изписват с етикети **Платон** и **Ницше**, за да се проследява дебатът.
...
|---------|--------------------|--------------------|-------|
| Gemma 3 - 12B Instruct | `@cf/google/gemma-3-12b-it` | Многоезичен и стабилен, добър за диалог и анализ | ⭐⭐⭐⭐⭐ |
| LLaMA 4 Scout - 17B | `@cf/meta/llama-4-scout-17b-16e-instruct` | Mixture-of-Experts модел с естествен стил | ⭐⭐⭐⭐☆ |
| Mistral Small 3.1 - 24B | `@cf/mistralai/mistral-small-3.1-24b-instruct` | Силен reasoning и широк контекст | ⭐⭐⭐⭐☆ |
| LLaMA 3.3 - 70B FP8 | `@cf/meta/llama-3.3-70b-instruct-fp8-fast` | Много задълбочен, но по-бавен | ⭐⭐⭐⭐☆ |
| LLaMA 3 - 8B Instruct | `@cf/meta/llama-3-8b-instruct` | Лек и бърз, стабилен за общи задачи | ⭐⭐⭐⭐ |
