...
5. Отговорите се изписват с етикети **Бот 1** и **Бот 2**, за да се проследява дебатът.
6. При нужда може да прикачите изображение или файл чрез бутона **"Качи файл"**.
7. Формата изпраща заявката към Worker бекенда и връща отговор от избрания модел(и).
