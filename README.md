...
*   **Дебат между ботове:** Бот 1 защитава автоматизацията чрез AI, а Бот 2 изтъква ролята на човешкия труд. И двамата отговарят кратко и директно на опонента си.
...
4. По желание включете **"Автодебат"** и наблюдавайте как Бот 1 брани автоматизацията, а Бот 2 се застъпва за хората. Опцията се спира от същата отметка или като напишете "стоп" в чата.
...
Активирайте отметката **"Автодебат"**, за да оставите двата бота да спорят сами. Бот 1 отстоява автоматизацията с AI, а Бот 2 брани човешкия труд.
Функцията `runDebateLoop()` извиква `handleSend()` на всеки три секунди и продължава,
докато опцията е включена. Може да прекъснете цикъла като махнете отметката или като напишете "стоп" в полето за чат.
