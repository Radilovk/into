...
2. Въведете свой API токен на Cloudflare Workers AI в полето и натиснете **"Запази токена"**.
3. Изпращайте съобщения през формата и ще получите отговори от избрания AI модел.
